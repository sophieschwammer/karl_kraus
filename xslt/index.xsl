...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title">
            <xsl:value-of select='"kk editionen"'/>
        </xsl:variable>
            ...
            <body class="d-flex flex-column h-100">
                ...
                <main class="flex-shrink-0 flex-grow-1">
                    <div class="container">
                        ...
                        <p>Diese digitale Edition präsentiert historische Dokumente, die im Rahmen der Lehrveranstaltung „Vom Archiv ins Frontend“ digital aufbereitet wurden.
                        </p>
